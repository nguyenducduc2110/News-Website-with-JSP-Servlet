...
![SCAYT Plugin for CKEditor 4 View](https:

This plugin brings the multi-language SCAYT functionality into CKEditor 4. It is integrated by default starting with [Standard Package of CKEditor 4](https:
...
The default version of SCAYT plugin for CKEditor 4 is using the free services of WebSpellChecker. It is provided with a banner ad and has some [limitations](https:

To lift the limitations and get rid of the banner, [obtain a license](https:

Demo
------------
SCAYT plugin for CKEditor 4: https:
...
There are also additional languages and specialized dictionaries available for a commercial license, you can check the full list [here](https:
...
* Demo: https:
* Documentation: https:
* YouTube video “How to Configure CKEditor 4 and SpellCheckAsYouType Plugin”: https:
* Term of Service: https:
* CKEditor’s How-Tos for SCAYT: https:
* CKEditor’s example of SCAYT: https:
...
Holders of an active subscription to the services or a commercial license have access to professional technical assistance directly from the WebSpellChecker team. [Contact us here](https:

Reporting issues
-------

Please use the [SCAYT plugin for CKEditor 4 GitHub issue page](https:

License
-------

This plugin is licensed under the terms of any of the following licenses at your choice: [GPL](http:

See LICENSE.md for more information.

Developed by [WebSpellChecker](https:
